...
async function clearCollectionsAndMigrate() {
     ...
     try {
          ...
          // Clear existing collections in destination
          console.log('\n🗑️ Clearing existing collections in destination...');
          const existingCollections = await destDb.listCollections().toArray();

          for (const collection of existingCollections) {
               console.log(`   - Dropping collection: ${collection.name}`);
               await destDb.collection(collection.name).drop();
          }
